...
từng message. Ảnh Slack Firing của alert rate-limit và Grafana panel là
artefact bổ sung còn cần operator chụp; link Alertmanager nội bộ vẫn pending và
không được public hóa.
